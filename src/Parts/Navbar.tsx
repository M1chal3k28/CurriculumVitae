            ...
            <div className="max-w-5xl mx-auto px-2">
                <div className="flex justify-between">
                    <div className="flex space-x-4">
                        {/* <!-- logo --> */}
                        <div>
                            <Link to={basePath} className="flex items-center py-4 px-3">
                    ...
                    <div className="hidden md:flex items-center">
                        <Link to={basePath} className="py-2 px-3 text-gray-700 font-bold bg-black-300 hover:bg-last rounded transition duration-300">Courses</Link>
                    </div>
