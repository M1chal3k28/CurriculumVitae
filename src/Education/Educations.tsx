...
const Educations: Education[] = [
    {
        ...
        content: (
            <div>
                I train <a href="https://leetcode.com" target="_blank" className="underline font-bold">Leetcode</a> every day. Challanges are about DSA(Data Structure and Algorithms). I got 2 badges: 50 day streak, MayLeetCoding challange
            </div>
        ),
